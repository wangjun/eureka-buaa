...
public abstract class SDSQLiteOpenHelper {  
	...
	/**
	 * 复写SQLiteOpenHelper类，使用SD卡上的数据库
	 * 数据库路径为：/sdcard/Eureka
	 */
    ...
    public synchronized SQLiteDatabase getWritableDatabase() {  
        ...
        try {  
            ...
            if (mName == null) {  
                ...
                db = SQLiteDatabase.openOrCreateDatabase(path, mFactory);  // 传入数据库的路径
            }  
    ...
    public File getDatabasePath(String name) {  
        ...
        {  
            ...
            + File.separator+Constants.dbDirName+File.separator;          //SD Card 中词库的位置 
